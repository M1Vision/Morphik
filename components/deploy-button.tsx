...
export const DeployButton = () => (
  <Link
    ...
    className="inline-flex items-center gap-2 ml-2 bg-black text-white text-sm px-3 py-1.5 rounded-md hover:bg-zinc-900 dark:bg-white ocean:bg-white dark:text-black ocean:text-black dark:hover:bg-zinc-100"
  >
    <svg
